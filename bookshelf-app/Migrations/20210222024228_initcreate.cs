        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "VARCHAR(40)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageAuthorId = table.Column<Guid>(type: "VARCHAR(40)", nullable: true),
                    ChatId = table.Column<Guid>(type: "VARCHAR(40)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookISBN", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookISBN_Books_BookId",
                        column: x => x.BookId,
