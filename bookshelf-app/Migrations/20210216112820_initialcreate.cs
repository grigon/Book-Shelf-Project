    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ChatId = table.Column<string>(type: "VARCHAR(30)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<string>(type: "VARCHAR(30)", nullable: true),
                    GenreId = table.Column<string>(type: "VARCHAR(30)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserBook = table.Column<string>(type: "VARCHAR(30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "VARCHAR(30)", nullable: false),
                    ChatId = table.Column<string>(type: "VARCHAR(30)", nullable: true),
                    UserId = table.Column<string>(type: "VARCHAR(36)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageAuthorId = table.Column<string>(type: "VARCHAR(36)", nullable: true),
                    ChatId = table.Column<string>(type: "VARCHAR(30)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "VARCHAR(36)", nullable: true),
                    BookId = table.Column<string>(type: "VARCHAR(30)", nullable: true),
