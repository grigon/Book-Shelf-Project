...
namespace bookshelf.FakeData
{
    public class DataFakeRepository : IBaseRepository<UserBook>
    {
            ...
            UserBooks = new List<UserBook>()
            {
                new UserBook
                {
                    ...
                    Book = new Book {Id = Guid.NewGuid(), Title = "Invincible", Author = new Author {Id = Guid.NewGuid(), FirstName="Amy",
                            LastName = "Lawernce"}, Genre = new Genre {Id = Guid.NewGuid(), Name = "Documentary"}, Rating= 9, CoverPath = "../images/cover1.jpg" },
                    User = alonzo,
                    Borrowed = false,
                    IsPublic = true
                ...
                new UserBook
                {
                    ...
                    Book =  new Book {Id = Guid.NewGuid(), Title = "Think and Grow Rich", Author = new Author {Id = Guid.NewGuid(), FirstName="Napoleon",
                            LastName = "Hill"}, Genre = new Genre {Id = Guid.NewGuid(), Name = "Self-development"}, Rating= 9, CoverPath = "../images/cover2.jpg"  },
                    User = alonzo,
                    Borrowed = false,
                    IsPublic = true
                },
                new UserBook
                {
                    ...
                    Book = new Book {Id = Guid.NewGuid(), Title = "Witcher", Author = new Author {Id = Guid.NewGuid(), FirstName="Andrzej",
                            LastName = "Sapkowski"}, Genre = new Genre {Id = Guid.NewGuid(), Name = "Fantasy"}, Rating= 9, CoverPath = "../images/cover3.jpg"  },
                    User = alonzo,
                    Borrowed = false,
                    IsPublic = true
                },
                new UserBook
                {
                    ...
                    Book = new Book {Id = Guid.NewGuid(), Title = "Solaris", Author = new Author {Id = Guid.NewGuid(), FirstName="Stanisław",
                            LastName = "Lem"}, Genre = new Genre {Id = Guid.NewGuid(), Name = "Sci-fi"}, Rating= 9,CoverPath =  "../images/cover4.jpg" },
                    User = alonzo,
                    Borrowed = false,
                    IsPublic = true
                },
                new UserBook
                {
                    ...
                    Book = new Book {Id = Guid.NewGuid(), Title = "The Long Earth", Author = new Author {Id = Guid.NewGuid(), FirstName="Terry",
                            LastName = "Pratchett"}, Genre = new Genre {Id = Guid.NewGuid(), Name = "Fantasy"}, Rating= 8, CoverPath =  "../images/cover5.jpg" },
                    User = alonzo,
                    Borrowed = false,
                    IsPublic = true
                }
        ...
        UserBook IBaseRepository<UserBook>.Add(UserBook t)
        {
            throw new NotImplementedException();
        }

        UserBook IBaseRepository<UserBook>.Remove(Guid id)
        {
            throw new NotImplementedException();
        }
    }
